...
// create and view projects route
  projectRoutes.post(ProjectController.postProjects);

  projectRoutes.get(ProjectController.getProjects);

  //Create endpoint handlers for /projects/:project_id
  projectRoutes.get('/projects/:project_id', ProjectController.getProject);
  projectRoutes.put(ProjectController.putProject);
  projectRoutes.delete(ProjectController.deleteProject);
